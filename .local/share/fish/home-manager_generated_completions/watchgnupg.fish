# watchgnupg
# Autogenerated from man page /nix/store/wfsqj2kiqsnrp24gjfrw2bprrmzca31i-gnupg-2.4.7/share/man/man1/watchgnupg.1.gz
complete -c watchgnupg -l force -d 'Delete an already existing socket file'
complete -c watchgnupg -l homedir -d 'If no socket name is given on the command line, pass DIR to gpgconf so that t…'
