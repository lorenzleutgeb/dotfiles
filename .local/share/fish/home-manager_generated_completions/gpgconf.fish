# gpgconf
# Autogenerated from man page /nix/store/wfsqj2kiqsnrp24gjfrw2bprrmzca31i-gnupg-2.4.7/share/man/man1/gpgconf.1.gz
...
complete -c gpgconf -l list-dirs
complete -c gpgconf -s L -d 'Lists the directories used by gpgconf'
...
complete -c gpgconf -l reload
complete -c gpgconf -s R -d 'Reload all or the given component'
complete -c gpgconf -l launch -d 'If the component is not already running, start it'
complete -c gpgconf -l kill
complete -c gpgconf -s K -d 'Kill the given component that runs as a daemon, including gpg-agent, dirmngr,…'
complete -c gpgconf -l create-socketdir -d 'Create a directory for sockets below /run/user or /var/run/user'
complete -c gpgconf -l remove-socketdir -d 'Remove a directory created with command --create-socketdir'
complete -c gpgconf -l unlock
complete -c gpgconf -l lock -d 'Remove a stale lock file hold for `file\''
