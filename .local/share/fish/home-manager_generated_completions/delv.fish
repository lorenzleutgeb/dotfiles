# delv
# Autogenerated from man page /nix/store/lkxalk7qzq2r1k8cry3wpi354kbxn9sn-bind-9.20.7-man/share/man/man1/delv.1.gz
complete -c delv -s a -d 'This option specifies a file from which to read an alternate DNSSEC root zone…'
