# fuser
# Autogenerated from man page /nix/store/ci7s9flis9dn31lh1pjy4flz1vhllx9r-psmisc-23.7/share/man/man1/fuser.1.gz
...
complete -c fuser -s 6 -d options
complete -c fuser -o HUP -d 'or by number (e. g. ,'
complete -c fuser -s 1 -d 'This option is silently ignored if the'
complete -c fuser -l ipv6 -d 'Search only for IPv6 sockets.   This option must not be used with the'
