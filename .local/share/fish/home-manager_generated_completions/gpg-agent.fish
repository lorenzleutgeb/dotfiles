# gpg-agent
# Autogenerated from man page /nix/store/wfsqj2kiqsnrp24gjfrw2bprrmzca31i-gnupg-2.4.7/share/man/man1/gpg-agent.1.gz
...
complete -c gpg-agent -l debug -d 'Set debug flags.   All flags are or-ed and flags may be given in C syntax (e'
...
complete -c gpg-agent -l steal-socket -d 'In --daemon mode, gpg-agent detects an already running gpg-agent and does not…'
...
complete -c gpg-agent -l no-user-trustlist -d 'Entirely ignore the user trust list and consider only the global trustlist (\'…'
complete -c gpg-agent -l sys-trustlist-name -d 'Changes the default name for the global trustlist from "trustlist'
...
complete -c gpg-agent -l enable-extended-key-format -d 'TQ   --disable-extended-key-format These options are obsolete and have no eff…'
complete -c gpg-agent -l enable-ssh-support -d 'TQ   --enable-win32-openssh-support '
...
complete -c gpg-agent -l disable-extended-key-format -d 'These options are obsolete and have no effect'
complete -c gpg-agent -l enable-win32-openssh-support
