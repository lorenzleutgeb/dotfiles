# dateconv
# Autogenerated from man page /nix/store/dvmncbpggrpmw3m62k15az6yw3rl8vrr-dateutils-0.4.11/share/man/man1/dateconv.1.gz
...
complete -c dateconv -s E -l empty-mode -d 'Empty lines that cannot be parsed'
