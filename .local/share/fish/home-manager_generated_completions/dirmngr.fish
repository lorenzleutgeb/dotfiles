# dirmngr
# Autogenerated from man page /nix/store/wfsqj2kiqsnrp24gjfrw2bprrmzca31i-gnupg-2.4.7/share/man/man8/dirmngr.8.gz
...
complete -c dirmngr -l compatibility-flags -d 'Set compatibility flags to work around certain problems or to emulate bugs'
complete -c dirmngr -l faked-system-time -d 'This option is only useful for testing; it sets the system time back or forth…'
complete -c dirmngr -l debug-level -d 'Select the debug level for investigating problems'
complete -c dirmngr -l debug -d 'Set debug flags.   All flags are or-ed and flags may be given in C syntax (e'
...
complete -c dirmngr -l honor-http-proxy -d 'If the environment variable \'http_proxy\' has been set, use its value to acces…'
...
complete -c dirmngr -l ignore-crl-extension -d 'Add oid to the list of ignored CRL extensions'
...
complete -c dirmngr -l keyserver-options -d 'particular keyserver'
