# catman
# Autogenerated from man page /nix/store/6y6ijw6avikf17cyks2k07vc9q1wq31v-man-db-2.13.0/share/man/man8/catman.8.gz
...
complete -c catman -s C -l config-file -d 'Use this user configuration file rather than the default of R \\(ti/. manpath '
