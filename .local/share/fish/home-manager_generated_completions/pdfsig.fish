# pdfsig
# Autogenerated from man page /nix/store/lj6a48mgzqfdv42bjyizfifci1wmwzxq-poppler-utils-24.02.0/share/man/man1/pdfsig.1.gz
...
complete -c pdfsig -o dump -d 'Dump all signatures into current directory in their native format'
...
complete -c pdfsig -o sign -d 'Sign the document in the specified signature field present in the document (m…'
complete -c pdfsig -o nick -d 'Use the certificate with the given nickname for signing (NSS backend)'
complete -c pdfsig -o backend -d 'Use the specified backeng for cryptographic signatures'
...
complete -c pdfsig -o list-backends -d 'List available backends for cryptographic signatures'
