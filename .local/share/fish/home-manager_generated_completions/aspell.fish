# aspell
# Autogenerated from man page /nix/store/18f1x8cvrxpc67872lkxrgjf4c9hb5fc-aspell-0.60.8.1/share/man/man1/aspell.1.gz
...
complete -c aspell -l add-html-skip -l rem-html-skip -d 'Add or remove a list of HTML tags to always skip while spell checking'
...
complete -c aspell -l add-sgml-skip -l rem-sgml-skip -d 'Add or remove a list of SGML tags to always skip while spell checking'
...
complete -c aspell -l add-texinfo-ignore -l rem-texinfo-ignore -d 'Add or remove a list of Texinfo commands'
complete -c aspell -l add-texinfo-ignore-env -l rem-texinfo-ignore-env -d 'Add or remove a list of Texinfo environments to ignore'
complete -c aspell -l context-visible-first -l dont-context-visible-first -d 'Switch the context which should be visible to Aspell'
complete -c aspell -l add-context-delimiters -l rem-context-delimiters -d 'Add or remove pairs of delimiters'
