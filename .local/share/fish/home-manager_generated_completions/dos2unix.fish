# dos2unix
# Autogenerated from man page /nix/store/2m1nlsr78l7d4vbws4l0bjs04v821f3c-dos2unix-7.5.2/share/man/man1/dos2unix.1.gz
complete -c dos2unix -l allow-chown -d 'Allow file ownership change in old file mode'
complete -c dos2unix -o ascii -d 'Default conversion mode.  See also section \\s-1CONVERSION MODES. \\s0'
...
complete -c dos2unix -s e -l add-eol -d 'Add a line break to the last line if there isn\'t one'
...
complete -c dos2unix -l no-add-eol -d 'Do not add a line break to the last line if there isn\'t one'
complete -c dos2unix -s O -l to-stdout -d 'Write to standard output, like a Unix filter'
