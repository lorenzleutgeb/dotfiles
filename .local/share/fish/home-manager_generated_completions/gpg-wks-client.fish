# gpg-wks-client
# Autogenerated from man page /nix/store/wfsqj2kiqsnrp24gjfrw2bprrmzca31i-gnupg-2.4.7/share/man/man1/gpg-wks-client.1.gz
...
complete -c gpg-wks-client -l add-revocs -d 'TQ   --no-add-revocs If enabled append revocation certificates for the same a…'
...
complete -c gpg-wks-client -l no-add-revocs -d 'If enabled append revocation certificates for the same addrspec as used in th…'
complete -c gpg-wks-client -l help -d 'Display a brief help page and exit.  EXAMPLES'
