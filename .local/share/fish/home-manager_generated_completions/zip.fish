# zip
# Autogenerated from man page /nix/store/l2q0dnjiv2c1hz98xva7qjma14zfrivl-zip-3.0/share/man/man1/zip.1.gz
complete -c zip -s @
...
complete -c zip -s 6
complete -c zip -l use-privileges -d '[WIN32] Use priviliges (if granted) to obtain all aspects of WinNT security'
