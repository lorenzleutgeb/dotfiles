# gh-search-commits
# Autogenerated from man page /nix/store/aapnxgvkl1xx1s13c93k8d18f3vlg9r0-gh-2.72.0/share/man/man1/gh-search-commits.1.gz
...
complete -c gh-search-commits -s w -l web -d 'Open the search query in the web browser JSON FIELDS author, commit, committe…'
