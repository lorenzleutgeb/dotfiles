# javac
# Autogenerated from man page /nix/store/5yii18di89wpxcffk3cihpzfdrzw54gl-openjdk-21.0.7+6/share/man/man1/javac.1
...
complete -c javac -o Xdoclint -d 'Enables recommended checks for problems in documentation comments'
