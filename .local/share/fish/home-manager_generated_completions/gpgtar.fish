# gpgtar
# Autogenerated from man page /nix/store/wfsqj2kiqsnrp24gjfrw2bprrmzca31i-gnupg-2.4.7/share/man/man1/gpgtar.1.gz
...
complete -c gpgtar -l no-compress -d 'This option tells gpg to disable compression (i. e.  using option -z0)'
...
complete -c gpgtar -l tar -d 'This is a dummy option for backward compatibility'
