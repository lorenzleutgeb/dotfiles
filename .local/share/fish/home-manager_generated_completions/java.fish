# java
# Autogenerated from man page /nix/store/5yii18di89wpxcffk3cihpzfdrzw54gl-openjdk-21.0.7+6/share/man/man1/java.1
...
complete -c java -l upgrade-module-path -d 'It also includes the new --enable-preview option, described in JEP 12'
...
complete -c java -l class-path -o classpath -o cp -d 'Specifies a list of directories, JAR files, and ZIP archives to search for cl…'
...
complete -c java -l finalization -d 'Controls whether the JVM performs finalization of objects'
complete -c java -l module-path -s p -d 'Specifies where to find application modules with a list of path elements'
...
complete -c java -o Xcomp -d 'Testing mode to exercise JIT compilers'
...
complete -c java -o Xms -d 'Sets the minimum and the initial size (in bytes) of the heap'
complete -c java -o Xms6291456
complete -c java -o Xms6144k
complete -c java -o Xms6m -d 'If you do not set this option, then the initial size will be set as the sum o…'
complete -c java -o XX:InitialHeapSize
...
complete -c java -o XX:FlightRecorderOptions -o XX:FlightRecorderOptions:parameter -d 'Sets the parameters that control the behavior of JFR'
...
complete -c java -o XX:TrimNativeHeapInterval -d 'Interval, in ms, at which the JVM will trim the native heap'
complete -c java -o XX:+NeverActAsServerClassMachine -d 'Enable the [dq]Client VM emulation[dq] mode which only uses the C1 JIT compil…'
complete -c java -o XX:MaxRAM -d 'The string [dq]emulated-client[dq] is added to the JVM version string'
complete -c java -o XX:CompilationMode
complete -c java -o XX:TieredStopAtLevel
...
complete -c java -o XX:+VerifySharedSpaces -d 'If this option is specified, the JVM will load a CDS archive file only if it …'
...
complete -c java -o XX:-UseContainerSupport -d 'Linux only: The VM now provides automatic container detection support, which …'
...
complete -c java -o XX:+AllowUserSignalHandlers -d 'Non-Windows: Enables installation of signal handlers by the application'
complete -c java -o XX:VMOptionsFile -d 'Allows user to specify VM options in a file, for example, java -XX:VMOptionsF…'
complete -c java -o XX:UseBranchProtection -d 'Linux AArch64 only: Specifies the branch protection mode'
...
complete -c java -o XX:+SegmentedCodeCache -d 'Enables segmentation of the code cache, without which the code cache consists…'
...
complete -c java -o XX:+UseChaCha20Intrinsics -d 'Enable ChaCha20 intrinsics'
complete -c java -o XX:-UseChaCha20Intrinsics -d 'Flags that control intrinsics now require the option'
complete -c java -o XX:+UsePoly1305Intrinsics -d 'Enable Poly1305 intrinsics'
complete -c java -o XX:-UsePoly1305Intrinsics -d 'Flags that control intrinsics now require the option'
...
complete -c java -o XX:+DTraceAllocProbes -d 'Linux and macOS: Enable dtrace tool probes for object allocation'
complete -c java -o XX:+DTraceMethodProbes -d 'Linux and macOS: Enable dtrace tool probes for method-entry and method-exit'
complete -c java -o XX:+DTraceMonitorProbes -d 'Linux and macOS: Enable dtrace tool probes for monitor events'
...
complete -c java -o XX:+ExtendedDTraceProbes -d 'Linux and macOS: Enables additional dtrace tool probes that affect performance'
complete -c java -o Xlog:codecache -d 'To see the code heap state when a [dq]CodeCache full[dq] condition exists, st…'
...
complete -c java -o Xlog:class+load -d 'T}	T{ Use level=info for regular information, or level=debug for additional i…'
complete -c java -o Xlog:class+preorder -d 'T}	T{ Not Applicable T} T{ TraceClassUnloading T}	T{'
...
complete -c java -o Xlog:class+resolve -d 'T}	T{ Not Applicable T} T{ TraceClassInitialization T}	T{'
complete -c java -o Xlog:class+init -d 'T}	T{ Not Applicable T} T{ TraceLoaderConstraints T}	T{'
complete -c java -o Xlog:class+loader+constraints -d 'T}	T{ Not Applicable T} T{ TraceClassLoaderData T}	T{'
...
complete -c java -o Xlog:monitorinflation -d 'T}	T{ Not Applicable T} T{ TraceRedefineClasses T}	T{'
...
complete -c java -o Xshare:dump -d '[bu] 2'
complete -c java -o XX:ArchiveClassesAtExit -d '[bu] 2 jcmd VM. cds'
complete -c java -o XX:+RecordDynamicDumpInfo -d 'application start-up script with the same technique: env JAVA_TOOL_OPTIONS=-X…'
complete -c java -o XX:+AutoCreateSharedArchive -d 'creating/using CDS archives'
complete -c java -o Xbootclasspath/a -d '(--module-path) can contain non-empty directories'
