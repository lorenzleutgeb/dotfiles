# gh-search-prs
# Autogenerated from man page /nix/store/aapnxgvkl1xx1s13c93k8d18f3vlg9r0-gh-2.72.0/share/man/man1/gh-search-prs.1.gz
complete -c gh-search-prs -l app -d 'Filter by GitHub App author'
complete -c gh-search-prs -l archived -d 'Filter based on the repository archived state {true|false}'
...
complete -c gh-search-prs -l project -d 'Filter on project board owner/number'
complete -c gh-search-prs -l reactions -d 'Filter on number of reactions'
complete -c gh-search-prs -s R -l repo -d 'Filter on repository'
...
complete -c gh-search-prs -s w -l web -d 'Open the search query in the web browser JSON FIELDS assignees, author, autho…'
