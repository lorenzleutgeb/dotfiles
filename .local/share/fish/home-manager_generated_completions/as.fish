# as
# Autogenerated from man page /nix/store/h63chk2fbkmxxzzllkq09p8g8yy9g8x1-binutils-wrapper-2.44-man/share/man/man1/as.1.gz
complete -c as -s a -d 'X Item "-a[cdghilmns]" Turn on listings, in any of a variety of ways: . RS 4'
...
complete -c as -o ali -d 'X Item "-ali" include assembly with ginsn'
...
complete -c as -s D -d 'X Item "-D" Enable debugging in target specific backends, if supported'
...
complete -c as -l info -d 'X Item "--info" Don\\*(Aqt suppress informational messages'
complete -c as -l no-info -d 'X Item "--no-info" Suppress informational messages'
complete -c as -s I -d 'X Item "-I dir" Add directory dir to the search list for \\f(CW\\*(C`'
complete -c as -s J -d 'X Item "-J" Don\\*(Aqt warn about signed overflow'
...
complete -c as -l scfi -d 'X Item "--scfi=experimental" This option controls whether the assembler shoul…'
...
complete -c as -l warn -d 'X Item "--warn" Don\\*(Aqt suppress warning messages or treat them as errors'
...
complete -c as -o mdialect -d 'X Item "-mdialect=dialect" This option specifies the assembly language dialec…'
complete -c as -o misa-spec -d 'X Item "-misa-spec=spec" This option specifies the version of the BPF instruc…'
complete -c as -o mno-relax -d 'X Item "-mno-relax" This option tells the assembler to not relax instructions'
...
complete -c as -o h-tick-hex -d 'X Item "-h-tick-hex" Support H\\*(Aq00 style hex constants in addition to 0x00…'
...
complete -c as -o moperand-check -d 'X Item "-moperand-check=none"'
...
complete -c as -o mnaked-reg -d 'X Item "-mnaked-reg" This option specifies that registers don\\*(Aqt require a…'
...
complete -c as -o mtls-check -d 'X Item "-mtls-check=no"'
...
complete -c as -o mpic -o mno-pic -d 'X Item "-mpic | -mno-pic" Generate position-independent (or position-dependen…'
complete -c as -o mall -d 'X Item "-mall"'
complete -c as -o mall-extensions -d 'X Item "-mall-extensions" . PD Enable all instruction set extensions'
complete -c as -o mno-extensions -d 'X Item "-mno-extensions" Disable all instruction set extensions'
complete -c as -o mextension -o mno-extension -d 'X Item "-mextension | -mno-extension" Enable (or disable) a particular instru…'
complete -c as -o mmachine -d 'X Item "-mmachine" Enable the instruction set extensions supported by a parti…'
complete -c as -o mb -d 'X Item "-mb" Generate "big endian" format output'
complete -c as -o ml -d 'X Item "-ml" Generate "little endian" format output'
...
complete -c as -o fno-pic -d 'X Item "-fno-pic" Don\\*(Aqt generate position-independent code (default) '
...
complete -c as -o mpower11 -o mpwr11 -d 'X Item "-mpower11, -mpwr11" Generate code for Power11 architecture'
complete -c as -o mfuture -d 'X Item "-mfuture" Generate code for \\*(Aqfuture\\*(Aq architecture'
...
complete -c as -o mrelocatable -d 'X Item "-mrelocatable" Support for GCC\\*(Aqs -mrelocatable option'
complete -c as -o mrelocatable-lib -d 'X Item "-mrelocatable-lib" Support for GCC\\*(Aqs -mrelocatable-lib option'
...
complete -c as -o mno-arch-attr -d 'X Item "-mno-arch-attr" Don\\*(Aqt generate the default riscv elf attribute se…'
complete -c as -o mcsr-check -d 'X Item "-mcsr-check" Enable the CSR checking for the ISA-dependent CRS and th…'
complete -c as -o mno-csr-check -d 'X Item "-mno-csr-check" Don\\*(Aqt do CSR checking'
...
complete -c as -o mwarn-regtype-mismatch -d 'X Item "-mwarn-regtype-mismatch=strict"'
complete -c as -o mno-warn-regtype-mismatch -d 'X Item "-mno-warn-regtype-mismatch" '
...
complete -c as -l enable-x86-tls-check
