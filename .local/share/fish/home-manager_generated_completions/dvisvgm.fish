# dvisvgm
# Autogenerated from man page /nix/store/xgwsszsf9jy3fdhrrc6095i4jh095jrc-texlive-combined-full-2024-final/share/man/man1/dvisvgm.1
...
complete -c dvisvgm -l currentcolor -d 'This option tells dvisvgm to replace the specified color with CSS variable cu…'
complete -c dvisvgm -l embed-bitmaps -d 'Embeds the contents of bitmap files into the generated SVG files instead of a…'
...
complete -c dvisvgm -l message -d 'Prints a given message to the console after an SVG file has been written'
...
complete -c dvisvgm -s o -l output -d 'Sets the pattern that determines the names of the generated SVG files, option…'
...
complete -c dvisvgm -l fwoff -d 'ttfautohint library (m[blue]https://freetype. org/ttfautohintm[])'
...
complete -c dvisvgm -o Oall -o collapse-groups -d 'performs all optimizations except collapse-groups'
complete -c dvisvgm -o O-collapse-groups -d 'is identical to'
