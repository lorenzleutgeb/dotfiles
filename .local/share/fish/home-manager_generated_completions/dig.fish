# dig
# Autogenerated from man page /nix/store/lkxalk7qzq2r1k8cry3wpi354kbxn9sn-bind-9.20.7-man/share/man/man1/dig.1.gz
...
complete -c dig -s h -d 'Print a usage summary'
complete -c dig -s k -d 'This option tells dig to sign queries using TSIG or SIG(0) using a key read f…'
