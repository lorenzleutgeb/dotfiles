# unix2dos
# Autogenerated from man page /nix/store/2m1nlsr78l7d4vbws4l0bjs04v821f3c-dos2unix-7.5.2/share/man/man1/unix2dos.1.gz
complete -c unix2dos -l allow-chown -d 'Allow file ownership change in old file mode'
complete -c unix2dos -o ascii -d 'Default conversion mode.  See also section \\s-1CONVERSION MODES. \\s0'
...
complete -c unix2dos -s e -l add-eol -d 'Add a line break to the last line if there isn\'t one'
...
complete -c unix2dos -l no-add-eol -d 'Do not add a line break to the last line if there isn\'t one'
complete -c unix2dos -s O -l to-stdout -d 'Write to standard output, like a Unix filter'
