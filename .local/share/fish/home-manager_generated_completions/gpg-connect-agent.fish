# gpg-connect-agent
# Autogenerated from man page /nix/store/wfsqj2kiqsnrp24gjfrw2bprrmzca31i-gnupg-2.4.7/share/man/man1/gpg-connect-agent.1.gz
complete -c gpg-connect-agent -l dirmngr -d 'Connect to a running directory manager (keyserver client) instead of to the g…'
complete -c gpg-connect-agent -l keyboxd -d 'Connect to a running keybox daemon instead of to the gpg-agent'
complete -c gpg-connect-agent -s S -d 'TQ   --raw-socket name Connect to socket name assuming this is an Assuan styl…'
complete -c gpg-connect-agent -s E -d 'TQ   --exec Take the rest of the command line as a program and it\'s arguments…'
...
complete -c gpg-connect-agent -l chuid -d 'Change the current user to uid which may either be a number or a name'
...
complete -c gpg-connect-agent -l no-history -d 'In interactive mode the command line history is usually saved and restored to…'
...
complete -c gpg-connect-agent -l keyboxd-program -d 'Specify the keybox daemon program to be started if none is running'
...
complete -c gpg-connect-agent -s u
complete -c gpg-connect-agent -l unbuffered -d 'Set stdin and stdout into unbuffered I/O mode'
