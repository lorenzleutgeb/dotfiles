...
1. [Install](https://github.com/nix-community/vscode-nix-ide/blob/HEAD/install.md) the extension, and open a Nix file.  
1. [Syntax highlighting](https://github.com/nix-community/vscode-nix-ide/blob/HEAD/images/docs/nix-syntax-highlight.png) should work out of the box. Nix code blocks inside `markdown` files are also [supported](https://github.com/nix-community/vscode-nix-ide/blob/HEAD/images/docs/md-embed-nix.png).  
...
1. Syntax errors are [linted](https://github.com/nix-community/vscode-nix-ide/blob/HEAD/images/docs/linting.png) using `nix-instantiate`.  
